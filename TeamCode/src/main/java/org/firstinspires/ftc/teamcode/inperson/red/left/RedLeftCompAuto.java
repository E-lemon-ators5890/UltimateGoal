...
@Autonomous(name = "Red Left Competition Autonomous", group = "Red")
public class RedLeftCompAuto extends MatchOpMode {
        ...
        schedule(
                new SelectCommand(new HashMap<Object, Command>() {{
                    put(RingPipelineEx.Stack.FOUR, new ParallelCommandGroup(
                            ...
                            new RedLeftFourFarParkCommand(drivetrain, shooterWheels, feeder, intake, wobbleGoalArm, telemetry)
                    ));
                    put(RingPipelineEx.Stack.ONE, new ParallelCommandGroup(
                            new InstantCommand(vision::switchToHG, vision),
                            new RedLeftOneFarParkCommand(drivetrain, shooterWheels, feeder, intake, wobbleGoalArm, telemetry)
                    ));
