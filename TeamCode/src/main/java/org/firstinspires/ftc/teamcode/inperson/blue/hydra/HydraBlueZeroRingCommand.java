...
public class HydraBlueZeroRingCommand extends SequentialCommandGroup {
    public HydraBlueZeroRingCommand(Drivetrain drivetrain, ShooterWheels shooterWheels, ShooterFeeder feeder, Intake intake, WobbleGoalArm wobbleGoalArm, Telemetry telemetry) {
        ...
        addCommands(
                ...
                new SplineCommand(drivetrain, new Vector2d(20, 10), Math.toRadians(0), true),
