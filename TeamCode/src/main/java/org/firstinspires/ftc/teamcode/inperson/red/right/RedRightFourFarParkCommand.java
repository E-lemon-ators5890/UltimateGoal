...
public class RedRightFourFarParkCommand extends SequentialCommandGroup {
    public RedRightFourFarParkCommand(Drivetrain drivetrain, ShooterWheels shooterWheels, ShooterFeeder feeder, Intake intake, WobbleGoalArm wobbleGoalArm, Telemetry telemetry) {
