...
public class LightsadersBlueFourCommand extends SequentialCommandGroup {
    public LightsadersBlueFourCommand(Drivetrain drivetrain, ShooterWheels shooterWheels, ShooterFeeder feeder, Intake intake, WobbleGoalArm wobbleGoalArm, Telemetry telemetry) {
