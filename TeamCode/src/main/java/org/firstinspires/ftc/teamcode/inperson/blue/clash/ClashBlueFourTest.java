...
@Autonomous(name = "Clash Blue Four Test", group = "Blue")
public class ClashBlueFourTest extends MatchOpMode {
    ...
    public void matchStart() {
        feeder.retractFeed();
        schedule(new ClashBlueFourRingCommand(drivetrain, shooterWheels, feeder, intake, wobbleGoalArm, telemetry));
