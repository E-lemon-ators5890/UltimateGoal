...
@Autonomous(name = "Clash Red Zero Test", group = "RED")
@Disabled
public class ClashRedZeroTest extends MatchOpMode {
...
// Drivetrain Hardware Initializations
    ...
    public void matchStart() {
        feeder.retractFeed();
        //vision.switchToHG();
        schedule(new ClashRedZeroCommand(drivetrain, shooterWheels, feeder, intake, wobbleGoalArm, telemetry));
