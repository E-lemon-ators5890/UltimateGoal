...
public class RedLeftOneFarParkCommand extends SequentialCommandGroup {
    public RedLeftOneFarParkCommand(Drivetrain drivetrain, ShooterWheels shooterWheels, ShooterFeeder feeder, Intake intake, WobbleGoalArm wobbleGoalArm, Telemetry telemetry) {
