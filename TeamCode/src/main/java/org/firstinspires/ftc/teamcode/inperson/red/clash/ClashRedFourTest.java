...
import org.firstinspires.ftc.teamcode.inperson.red.clash.ClashRedZeroCommand;
...
@Autonomous(name = "Clash Red Four Test", group = "RED")
//@Disabled
public class ClashRedFourTest extends MatchOpMode {
...
// Drivetrain Hardware Initializations
    ...
    public void matchStart() {
        feeder.retractFeed();
        //vision.switchToHG();
        schedule(new ClashRedFourCommand(drivetrain, shooterWheels, feeder, intake, wobbleGoalArm, telemetry));
