...
@Autonomous(name = "Clash Blue One Test", group = "Blue")
@Disabled
public class ClashBlueOneTest extends MatchOpMode {
    ...
    public void matchStart() {
        feeder.retractFeed();
        schedule(new ClashBlueOneRingCommand(drivetrain, shooterWheels, feeder, intake, wobbleGoalArm, telemetry));
