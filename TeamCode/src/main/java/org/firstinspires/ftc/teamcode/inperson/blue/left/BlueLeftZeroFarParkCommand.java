...
public class BlueLeftZeroFarParkCommand extends SequentialCommandGroup {
    public BlueLeftZeroFarParkCommand(Drivetrain drivetrain, ShooterWheels shooterWheels, ShooterFeeder feeder, Intake intake, WobbleGoalArm wobbleGoalArm, Telemetry telemetry) {
