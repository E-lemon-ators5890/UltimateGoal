...
public class BlueRightFourFarParkCommand extends SequentialCommandGroup {
    public BlueRightFourFarParkCommand(Drivetrain drivetrain, ShooterWheels shooterWheels, ShooterFeeder feeder, Intake intake, WobbleGoalArm wobbleGoalArm, Telemetry telemetry) {
