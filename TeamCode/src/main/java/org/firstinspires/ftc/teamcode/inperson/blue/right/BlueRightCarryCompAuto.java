...
@Autonomous(name = "Blue Right Carry Competition Autonomous ", group = "Blue")
public class BlueRightCarryCompAuto extends MatchOpMode {
        ...
        schedule(
                new SelectCommand(new HashMap<Object, Command>() {{
                    put(RingPipelineEx.Stack.FOUR, new SequentialCommandGroup(
                            new BlueRightFourExtraRingCommand(drivetrain, shooterWheels, feeder, intake, wobbleGoalArm, telemetry)
                    ));
