...
public class ClashBlueZeroRingCommand extends SequentialCommandGroup {
    public ClashBlueZeroRingCommand(Drivetrain drivetrain, ShooterWheels shooterWheels, ShooterFeeder feeder, Intake intake, WobbleGoalArm wobbleGoalArm, Telemetry telemetry) {
