...
@Autonomous(name = "Inception Blue One Test", group = "Blue")
public class InceptionBlueOneTest extends MatchOpMode {
    ...
    public void matchStart() {
        feeder.retractFeed();
        schedule(new InceptionBlueOneCommand(drivetrain, shooterWheels, feeder, intake, wobbleGoalArm, telemetry));
