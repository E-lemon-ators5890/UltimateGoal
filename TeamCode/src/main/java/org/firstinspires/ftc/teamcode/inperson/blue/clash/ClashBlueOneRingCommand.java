...
public class ClashBlueOneRingCommand extends SequentialCommandGroup {
    public ClashBlueOneRingCommand(Drivetrain drivetrain, ShooterWheels shooterWheels, ShooterFeeder feeder, Intake intake, WobbleGoalArm wobbleGoalArm, Telemetry telemetry) {
