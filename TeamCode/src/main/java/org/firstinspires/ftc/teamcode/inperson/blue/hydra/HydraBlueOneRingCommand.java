...
public class HydraBlueOneRingCommand extends SequentialCommandGroup {
    public HydraBlueOneRingCommand(Drivetrain drivetrain, ShooterWheels shooterWheels, ShooterFeeder feeder, Intake intake, WobbleGoalArm wobbleGoalArm, Telemetry telemetry) {
