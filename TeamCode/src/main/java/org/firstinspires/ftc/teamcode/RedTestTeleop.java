...
public class RedTestTeleop extends MatchOpMode {
    // Motors
    ...
    private ModeChangingButton.GamepadMode currentMode = ModeChangingButton.GamepadMode.PRIMARY_MODE;
    ...
    /**
     * Change mode: DPAD_RIGHT
     * TEST BUTTON: LEFT_BUMPER (ON PRIMARY -> TRIPLE SHOT, ON SECONDARY -> SINGLE SHOT)
     */
    @Override
    public void configureButtons() {
        ...
        // TRIPLE SHOT SPEED *********************
        ModeChangingButton testButton = (new ModeChangingButton(driverGamepad, GamepadKeys.Button.LEFT_BUMPER, new FeedRingsCommand(feeder, 4,30), new FeedRingsCommand(feeder, 1,30), () -> currentMode));
        ...
        // Toggles the mode between primary and secondary
        (new GamepadButton(driverGamepad, GamepadKeys.Button.DPAD_RIGHT)).toggleWhenPressed(
                () -> currentMode = ModeChangingButton.GamepadMode.SECONDARY_MODE,
                () -> currentMode = ModeChangingButton.GamepadMode.PRIMARY_MODE
        );
