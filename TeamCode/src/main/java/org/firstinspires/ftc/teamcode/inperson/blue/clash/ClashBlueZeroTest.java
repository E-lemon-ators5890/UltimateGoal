...
@Autonomous(name = "Clash Blue Zero Test", group = "Blue")
public class ClashBlueZeroTest extends MatchOpMode {
    ...
    public void matchStart() {
        feeder.retractFeed();
        schedule(new ClashBlueZeroRingCommand(drivetrain, shooterWheels, feeder, intake, wobbleGoalArm, telemetry));
