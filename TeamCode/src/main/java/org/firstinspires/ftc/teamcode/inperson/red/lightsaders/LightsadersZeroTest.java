...
@Autonomous(name = "RED Lightsaders Zero Test", group = "RED")
//@Disabled
public class LightsadersZeroTest extends MatchOpMode {
...
// Drivetrain Hardware Initializations
    ...
    public void matchStart() {
        feeder.retractFeed();
        //vision.switchToHG();
        schedule(new LightsadersRedFourCommand(drivetrain, shooterWheels, feeder, intake, wobbleGoalArm, telemetry));
