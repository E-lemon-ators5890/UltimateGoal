...
public class RedRightZeroFarParkCommand extends SequentialCommandGroup {
    public RedRightZeroFarParkCommand(Drivetrain drivetrain, ShooterWheels shooterWheels, ShooterFeeder feeder, Intake intake, WobbleGoalArm wobbleGoalArm, Telemetry telemetry) {
