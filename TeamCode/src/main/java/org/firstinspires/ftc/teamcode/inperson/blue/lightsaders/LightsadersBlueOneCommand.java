...
public class LightsadersBlueOneCommand extends SequentialCommandGroup {
    public LightsadersBlueOneCommand(Drivetrain drivetrain, ShooterWheels shooterWheels, ShooterFeeder feeder, Intake intake, WobbleGoalArm wobbleGoalArm, Telemetry telemetry) {
