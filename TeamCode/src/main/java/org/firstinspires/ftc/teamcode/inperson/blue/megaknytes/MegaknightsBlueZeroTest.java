...
@Autonomous(name = "Megaknights Blue Zero Test", group = "Blue")
@Disabled
public class MegaknightsBlueZeroTest extends MatchOpMode {
    ...
    public void matchStart() {
        feeder.retractFeed();
        schedule(new MegaknightsBlueZeroCommand(drivetrain, shooterWheels, feeder, intake, wobbleGoalArm, telemetry));
